...
namespace _Project.Scripts.Gameplay.Features.AudioFeature.Components
{
    ...
    public struct AnimalSpawnedAudioConfig : IEcsAudioConfig
    {
		...
		[MovedFrom(autoUpdateAPI: false, sourceNamespace: "_Project.Scripts.Gameplay.Features.AudioFeature.Components", sourceClassName: "AnimalSpawnedAudioConfig/Template", sourceAssembly: "Assembly-CSharp")]
