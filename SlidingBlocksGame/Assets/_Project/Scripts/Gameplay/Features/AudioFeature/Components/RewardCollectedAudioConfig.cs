...
namespace _Project.Scripts.Gameplay.Features.AudioFeature.Components
{
    ...
    public struct RewardCollectedAudioConfig : IEcsAudioConfig
    {
		...
		[MovedFrom(autoUpdateAPI: false, sourceNamespace: "_Project.Scripts.Gameplay.Features.AudioFeature.Components", sourceClassName: "RewardCollectedAudioConfig/Template", sourceAssembly: "Assembly-CSharp")]
