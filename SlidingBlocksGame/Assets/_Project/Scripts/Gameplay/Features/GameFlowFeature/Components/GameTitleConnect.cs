...
namespace _Project.Scripts.Gameplay.Features.GameFlowFeature.Components
{
    ...
    public struct GameTitleConnect : IEcsComponent
    {
		...
		[MovedFrom(autoUpdateAPI: false, sourceNamespace: "_Project.Scripts.Gameplay.Features.GameFlowFeature.Components", sourceClassName: "GameTitleConnect/Template", sourceAssembly: "Assembly-CSharp")]
