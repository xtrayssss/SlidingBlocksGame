...
namespace _Project.Scripts.Gameplay.Features.GameFlowFeature.Components
{
    ...
    public struct HUDPrefab : IEcsComponent
    {
		...
		[MovedFrom(autoUpdateAPI: false, sourceNamespace: "_Project.Scripts.Gameplay.Features.GameFlowFeature.Components", sourceClassName: "HUDPrefab/Template", sourceAssembly: "Assembly-CSharp")]
