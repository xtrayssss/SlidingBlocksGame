...
namespace _Project.Scripts.Gameplay.Features.DestructionFeature.Components
{
    ...
    {
        [MovedFrom(autoUpdateAPI: false, sourceNamespace: "_Project.Scripts.Gameplay.Features.DestructionFeature.Components", sourceClassName: "DeleteEntityRequest/Template", sourceAssembly: "Assembly-CSharp")]
