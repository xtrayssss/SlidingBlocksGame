...
namespace _Project.Scripts.Gameplay.Features.TweenFeature.Components
{
    ...
    public struct TweenStartFloatValue : IEcsComponent
    {
		...
		[MovedFrom(autoUpdateAPI: false, sourceNamespace: "_Project.Scripts.Gameplay.Features.TweenFeature.Components", sourceClassName: "TweenStartFloatValue/Template", sourceAssembly: "Assembly-CSharp")]
